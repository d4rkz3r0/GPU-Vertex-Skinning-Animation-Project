...
#include "../../../App/AppHelpers/Math/VectorDefines.h"
#include <assimp/scene.h>

BoneAnimation::BoneAnimation(Model& model, aiNodeAnim& nodeAnim) : mModel(&model), mBone(nullptr), mKeyframes()
{
...
const vector<Keyframe*> BoneAnimation::Keyframes() const
{
	return mKeyframes;
}
